...
public class Indexer {
	...
	public static void main(String[] args) throws Exception {
		...
		int numIndexed=index(new File(FilePreprocess.INDEX_DIR),new File(FilePreprocess.DATA_DIR));// 调用index方法
	...
	public static int index(File indexDir, File dataDir) throws IOException {
		...
		if(!dataDir.exists() || !dataDir.isDirectory()){ throw new IOException(dataDir + " does not exist or is not a directory"); }
