...
package utils.framework.spring;
...
public class AutoPopulatingList<E> implements List<E>, Serializable {
	private static final long	serialVersionUID	=3353271196093215652L;
	...
	public AutoPopulatingList(List<E> backingList, ElementFactory<E> elementFactory) {
		AssertUtils.notNull(backingList, "Backing List must not be null");
		AssertUtils.notNull(elementFactory, "Element factory must not be null");
	...
	public static class ElementInstantiationException extends RuntimeException {
		private static final long	serialVersionUID	=-1890653982496513680L;
	...
	private static class ReflectiveElementFactory<E> implements ElementFactory<E>, Serializable {
		private static final long	serialVersionUID	=7182396466192303680L;
		private final Class<? extends E> elementClass;

		public ReflectiveElementFactory(Class<? extends E> elementClass) {
			AssertUtils.notNull(elementClass, "Element clas must not be null");
			AssertUtils.isTrue(!elementClass.isInterface(), "Element class must not be an interface type");
			AssertUtils.isTrue(!Modifier.isAbstract(elementClass.getModifiers()), "Element class cannot be an abstract class");
