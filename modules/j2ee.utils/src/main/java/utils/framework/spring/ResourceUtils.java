...
public abstract class ResourceUtils {
	...
	/** /WEB-INF/ */
	public static final String WEBCLASSSPATH_URL_PREFIX = "/WEB-INF/";
	...
	public static void main(String[] args) throws FileNotFoundException {
		String httpFilePath = "classpath:jetty/log4j.xml"; 
		System.out.println(getFile(httpFilePath).getAbsolutePath()); 
		httpFilePath = "file:C:/NTDETECT.COM";
		System.out.println(getFile(httpFilePath).getAbsolutePath());
	}
}
