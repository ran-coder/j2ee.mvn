...
public abstract class ClassUtils {
	...
	/**
	 * Resolve the given class name as primitive class, if appropriate, according
	 * to the JVM's naming rules for primitive classes.
	 * <p>
	 ...
	 * given class, but the original class in case of a CGLIB-generated subclass.
	 * 
	 * @param clazz
	 *           the class to check
	 * @return the user-defined class
	 ...
	 * trailing slash if necessary, and concatenating the specified resource name
	 * to this. <br/>
	 ...
	 * <code>Class.getResource</code> instead, a leading slash would also have to
	 * be prepended to the returned value.
	 * 
	 * @param clazz
