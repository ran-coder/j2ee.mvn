...
public class ZipEncrypt {
	private final static Logger	log	=LoggerFactory.getLogger(ZipEncrypt.class);
	...
	public static void encryptZip(String srcFile, String destfile, String keyfile) throws Exception {
		...
		AssertUtil.isTrue(f.createNewFile(),"cannot create file: "+f.toString());
		FileOutputStream fos=new FileOutputStream(f);
	 ...
	 * @param publicKey 公钥
	 */
	public static void decryptUnzip(String srcfile, String destfile, Key publicKey) throws Exception {
		// 先对文件解密
		File temp=new File(UUID.randomUUID().toString() + ".zip");
		temp.deleteOnExit();
	...
	public static void main(String args[]) throws Exception {
		// 要压缩的目录
		String srcPath="D:/Server/java/zip/file";
		// 压缩后的存放文件
		String destZip="D:/Server/java/zip/zipfile";
		// 压缩加密后的publickey
		String keyfile="";
		ZipEncrypt.encryptZip(srcPath,destZip,keyfile);

		/*
		 * 解密 ZipEncrypt.decryptUnzip("e:/comXXX/comxxxx.zip", "d:/comxxx", ZipEncrypt .getKey("e:/comXXX/public.key")); */
	}
}
