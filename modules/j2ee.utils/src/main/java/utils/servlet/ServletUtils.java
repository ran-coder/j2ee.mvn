/**
 * Copyright (c) 2005-2011 springside.org.cn Licensed under the Apache License, Version 2.0 (the "License"); $Id: ServletUtils.java 1595 2011-05-11 16:41:16Z calvinxiu $
 */
...
public abstract class ServletUtils {
	...
	public static void setFileDownloadHeader(HttpServletResponse response, String fileName) {
		if(fileName==null|| (fileName=fileName.trim()).length()<1  )return;
		String encodedFileName=null;
		try{encodedFileName=new String(fileName.getBytes(),"ISO8859-1");}catch(UnsupportedEncodingException e){}
		if(encodedFileName==null|| (encodedFileName=encodedFileName.trim()).length()<1  )return;
