...
import us.codecraft.webmagic.samples.model.IteyeBlog;
import us.codecraft.webmagic.samples.model.News163;
import us.codecraft.webmagic.samples.model.OschinaBlog;
...
public class QuickStarter{
	...
	public static void main(String[] args){
		...
		//Start spider
		OOSpider.create(Site.me().addStartUrl(urlMap.get(key)), clazzMap.get(key))
